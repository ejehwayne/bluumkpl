    ...
    {isMounted && items.map(({product}) => {
     ...
     return (
        ...
        <div className="flex-shrink-0">
            ...
            <p className="mt-4 flex space-x-2 text-sm text-gray-700">
             ...
             <span> Eligible For Intstant Delivery</span>
            </p>
        </div>
        </li>
     )
     ...
     <section className='mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8'>
       ...
       <div className="mt-6 space-y-4">
         ...
         <div className="flex items-center justify-between border-1 border-gray-200 pt-4">
         ...
         <div className="flex items-center justify-between border-1 border-gray-200">
